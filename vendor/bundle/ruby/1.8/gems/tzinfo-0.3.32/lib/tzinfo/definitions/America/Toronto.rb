    ...
    module America
      module Toronto
        ...
        timezone 'America/Toronto' do |tz|
          ...
          tz.transition 1895, 1, :o1, 52125005963, 21600
          tz.transition 1918, 4, :o2, 58120747, 24
          tz.transition 1918, 10, :o1, 9687575, 4
          tz.transition 1919, 3, :o2, 38752779, 16
          tz.transition 1919, 10, :o1, 7266773, 3
          tz.transition 1920, 5, :o2, 58138723, 24
          tz.transition 1920, 9, :o1, 7267781, 3
          tz.transition 1921, 5, :o2, 58147795, 24
          tz.transition 1921, 9, :o1, 9691791, 4
          tz.transition 1922, 5, :o2, 58156531, 24
          tz.transition 1922, 9, :o1, 9693259, 4
          tz.transition 1923, 5, :o2, 58165267, 24
          tz.transition 1923, 9, :o1, 9694715, 4
          tz.transition 1924, 5, :o2, 58173835, 24
          tz.transition 1924, 9, :o1, 9696199, 4
          tz.transition 1925, 5, :o2, 58182571, 24
          tz.transition 1925, 9, :o1, 9697655, 4
          tz.transition 1926, 5, :o2, 58191307, 24
          tz.transition 1926, 9, :o1, 9699111, 4
          tz.transition 1927, 5, :o2, 58200043, 24
