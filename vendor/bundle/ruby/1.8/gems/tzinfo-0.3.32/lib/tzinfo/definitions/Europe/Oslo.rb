    ...
    module Europe
      module Oslo
        ...
        timezone 'Europe/Oslo' do |tz|
          ...
          tz.transition 1940, 8, :o2, 29158229, 12
          ...
          tz.transition 1945, 10, :o1, 58361509, 24
          tz.transition 1959, 3, :o2, 58479421, 24
          tz.transition 1959, 9, :o1, 58483957, 24
          tz.transition 1960, 3, :o2, 58488325, 24
          tz.transition 1960, 9, :o1, 58492693, 24
          tz.transition 1961, 3, :o2, 58497061, 24
          tz.transition 1961, 9, :o1, 58501429, 24
          tz.transition 1962, 3, :o2, 58505797, 24
          tz.transition 1962, 9, :o1, 58510165, 24
          tz.transition 1963, 3, :o2, 58514533, 24
          tz.transition 1963, 9, :o1, 58518901, 24
          tz.transition 1964, 3, :o2, 58523269, 24
          tz.transition 1964, 9, :o1, 58527805, 24
          tz.transition 1965, 4, :o2, 58533013, 24
          tz.transition 1965, 9, :o1, 58536541, 24
