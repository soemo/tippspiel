    ...
    module America
      module Montreal
        ...
        timezone 'America/Montreal' do |tz|
          ...
          tz.transition 1919, 3, :o2, 38752781, 16
          tz.transition 1919, 10, :o1, 116268325, 48
          tz.transition 1920, 5, :o2, 38759149, 16
          tz.transition 1920, 10, :o1, 116284837, 48
          tz.transition 1921, 5, :o2, 58147459, 24
          tz.transition 1921, 10, :o1, 116302309, 48
          tz.transition 1922, 4, :o2, 58156195, 24
          tz.transition 1922, 10, :o1, 116319781, 48
          tz.transition 1924, 5, :o2, 58174147, 24
          tz.transition 1924, 9, :o1, 116354725, 48
          tz.transition 1925, 5, :o2, 58182571, 24
          tz.transition 1925, 9, :o1, 116372197, 48
          tz.transition 1926, 5, :o2, 58191307, 24
          tz.transition 1926, 9, :o1, 116389669, 48
          tz.transition 1927, 5, :o2, 58200041, 24
          tz.transition 1927, 9, :o1, 7275446, 3
          tz.transition 1928, 4, :o2, 58208777, 24
          tz.transition 1928, 9, :o1, 7276559, 3
          tz.transition 1929, 4, :o2, 58217513, 24
          tz.transition 1929, 9, :o1, 7277651, 3
          tz.transition 1930, 4, :o2, 58226249, 24
          tz.transition 1930, 9, :o1, 7278743, 3
          tz.transition 1931, 4, :o2, 58234985, 24
          tz.transition 1931, 9, :o1, 7279835, 3
          tz.transition 1932, 5, :o2, 58243889, 24
          tz.transition 1932, 9, :o1, 7280927, 3
          tz.transition 1933, 4, :o2, 58252625, 24
          tz.transition 1933, 10, :o1, 7282040, 3
          tz.transition 1934, 4, :o2, 58261361, 24
          tz.transition 1934, 9, :o1, 7283132, 3
          tz.transition 1935, 4, :o2, 58270097, 24
          tz.transition 1935, 9, :o1, 7284224, 3
          tz.transition 1936, 4, :o2, 58278833, 24
          tz.transition 1936, 9, :o1, 7285316, 3
          tz.transition 1937, 4, :o2, 58287569, 24
          tz.transition 1937, 9, :o1, 7286408, 3
          tz.transition 1938, 4, :o2, 58296305, 24
          tz.transition 1938, 9, :o1, 7287500, 3
          tz.transition 1939, 4, :o2, 58305209, 24
          tz.transition 1939, 9, :o1, 7288592, 3
          tz.transition 1940, 4, :o2, 58313945, 24
          ...
          tz.transition 1949, 10, :o1, 9732879, 4
          tz.transition 1950, 4, :o2, 58401643, 24
          tz.transition 1950, 10, :o1, 9734335, 4
          ...
          tz.transition 1955, 9, :o1, 9741503, 4
          tz.transition 1956, 4, :o2, 58454227, 24
          tz.transition 1956, 9, :o1, 9742987, 4
