...
http://github.com/newrelic/rpm/
  ...
  s.executables = [%q{newrelic_cmd}, %q{newrelic}, %q{mongrel_rpm}]
  s.extra_rdoc_files = [%q{CHANGELOG}, %q{LICENSE}, %q{README.rdoc}, %q{newrelic.yml}]
  s.files = [%q{bin/newrelic_cmd}, %q{bin/newrelic}, %q{bin/mongrel_rpm}, %q{CHANGELOG}, %q{LICENSE}, %q{README.rdoc}, %q{newrelic.yml}]
