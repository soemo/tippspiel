  ...
  context '#write_tip_input' do
    ...
    it 'returns corrct input html' do
      ...
      value = helper.capture_haml{
        expect(helper.write_tip_input(1, 'team1_goals', 2))
      }
      expect(value).to eq("<input type=\"text\" name=\"tips[1][team1_goals]\" id=\"tips_1_team1_goals\" value=\"2\" maxlength=\"2\" size=\"2\" class=\"tip_input\" />\n")
