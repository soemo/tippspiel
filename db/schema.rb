...
ActiveRecord::Schema.define(version: 2026_05_16_120003) do
  ...
  create_table "notices", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
