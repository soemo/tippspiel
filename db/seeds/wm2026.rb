...
module Seeds
  module Wm2026
    ...
    # FIFA 3-letter team codes used by football-data.org as `tla`.
    # Source: https://en.wikipedia.org/wiki/List_of_FIFA_country_codes
    # Used by Results::ImportFinishedGames to resolve FD matches → our Team records.
    def self.football_data_tla_map
      {
        'Ägypten'               => 'EGY',
        'Albanien'              => 'ALB',
        'Algerien'              => 'ALG',
    ...
    #   https://www.fifa.com/de/tournaments/mens/worldcup/canadamexicousa2026/scores-fixtures?country=DE&wtw-filter=ALL
    #
    ...
    def self.game_data
      [
        ...
        {start_at: '12.06.2026 04:00', place: 'Guadalajara',     team1_name: 'Südkorea',  team2_name: 'Tschechien', group: 'A', round: 'group'},
        {start_at: '18.06.2026 18:00', place: 'Atlanta',         team1_name: 'Tschechien',team2_name: 'Südafrika',  group: 'A', round: 'group'},
        ...
        {start_at: '24.06.2026 21:00', place: 'Vancouver',       team1_name: 'Schweiz',            team2_name: 'Kanada',             group: 'B', round: 'group'},
        {start_at: '24.06.2026 21:00', place: 'Seattle',         team1_name: 'Bosnien-Herzegowina',team2_name: 'Katar',              group: 'B', round: 'group'},
        ...
        {start_at: '20.06.2026 02:30', place: 'Philadelphia',    team1_name: 'Brasilien', team2_name: 'Haiti',     group: 'C', round: 'group'},
        ...
        {start_at: '20.06.2026 05:00', place: 'San Francisco',   team1_name: 'Türkei',    team2_name: 'Paraguay',  group: 'D', round: 'group'},
        ...
        {start_at: '25.06.2026 22:00', place: 'Philadelphia',    team1_name: 'Curaçao',       team2_name: 'Elfenbeinküste',group: 'E', round: 'group'},
        {start_at: '25.06.2026 22:00', place: 'New York',        team1_name: 'Ecuador',       team2_name: 'Deutschland',   group: 'E', round: 'group'},
        ...
        {start_at: '21.06.2026 06:00', place: 'Monterrey',       team1_name: 'Tunesien',   team2_name: 'Japan',    group: 'F', round: 'group'},
        ...
        {start_at: '27.06.2026 05:00', place: 'Seattle',         team1_name: 'Ägypten',   team2_name: 'Iran',      group: 'G', round: 'group'},
        {start_at: '27.06.2026 05:00', place: 'Vancouver',       team1_name: 'Neuseeland',team2_name: 'Belgien',   group: 'G', round: 'group'},
        ...
        {start_at: '27.06.2026 02:00', place: 'Houston',         team1_name: 'Kap Verde',    team2_name: 'Saudi-Arabien',group: 'H', round: 'group'},
        {start_at: '27.06.2026 02:00', place: 'Guadalajara',     team1_name: 'Uruguay',      team2_name: 'Spanien',      group: 'H', round: 'group'},
        ...
        {start_at: '26.06.2026 21:00', place: 'Boston',          team1_name: 'Norwegen',  team2_name: 'Frankreich',group: 'I', round: 'group'},
        {start_at: '26.06.2026 21:00', place: 'Toronto',         team1_name: 'Senegal',   team2_name: 'Irak',    group: 'I', round: 'group'},

        # ── Group J: Argentinien, Algerien, Österreich, Jordanien ────────────
        {start_at: '17.06.2026 03:00', place: 'Kansas City',     team1_name: 'Argentinien',team2_name: 'Algerien',  group: 'J', round: 'group'},
        ...
        {start_at: '28.06.2026 04:00', place: 'Kansas City',     team1_name: 'Algerien',   team2_name: 'Österreich',group: 'J', round: 'group'},
        {start_at: '28.06.2026 04:00', place: 'Dallas',          team1_name: 'Jordanien',  team2_name: 'Argentinien',group: 'J', round: 'group'},
        ...
        {start_at: '18.06.2026 04:00', place: 'Mexico City',    team1_name: 'Usbekistan',team2_name: 'Kolumbien', group: 'K', round: 'group'},
        {start_at: '23.06.2026 19:00', place: 'Houston',         team1_name: 'Portugal',  team2_name: 'Usbekistan',group: 'K', round: 'group'},
        {start_at: '24.06.2026 04:00', place: 'Guadalajara',     team1_name: 'Kolumbien', team2_name: 'DR Kongo',  group: 'K', round: 'group'},
        ...
        {start_at: '30.06.2026 03:00', place: 'Monterrey',       team1_placeholder_name: '1F',         team2_placeholder_name: '2C',         group: nil, round: 'roundof32'},
        ...
        {start_at: '01.07.2026 03:00', place: 'Mexico City',    team1_placeholder_name: '1A',         team2_placeholder_name: '3C/E/F/H/I', group: nil, round: 'roundof32'},
        ...
        {start_at: '01.07.2026 22:00', place: 'Seattle',         team1_placeholder_name: '1G',         team2_placeholder_name: '3A/E/H/I/J', group: nil, round: 'roundof32'},
        {start_at: '03.07.2026 01:00', place: 'Toronto',         team1_placeholder_name: '2K',         team2_placeholder_name: '2L',         group: nil, round: 'roundof32'},
        {start_at: '02.07.2026 21:00', place: 'Los Angeles',     team1_placeholder_name: '1H',         team2_placeholder_name: '2J',         group: nil, round: 'roundof32'},
        {start_at: '03.07.2026 05:00', place: 'Vancouver',       team1_placeholder_name: '1B',         team2_placeholder_name: '3E/F/G/I/J', group: nil, round: 'roundof32'},
        {start_at: '04.07.2026 00:00', place: 'Miami',           team1_placeholder_name: '1J',         team2_placeholder_name: '2H',         group: nil, round: 'roundof32'},
        ...
        {start_at: '03.07.2026 20:00', place: 'Dallas',          team1_placeholder_name: '2D',         team2_placeholder_name: '2G',         group: nil, round: 'roundof32'},

        # ── Round of 16 (match numbers 89-96) ────────────────────────────────
        {start_at: '04.07.2026 23:00', place: 'Philadelphia',    team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '04.07.2026 19:00', place: 'Houston',         team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '05.07.2026 22:00', place: 'New York',        team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '06.07.2026 02:00', place: 'Mexico City',    team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '06.07.2026 21:00', place: 'Dallas',          team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '07.07.2026 02:00', place: 'Seattle',         team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '07.07.2026 18:00', place: 'Atlanta',         team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},
        {start_at: '07.07.2026 22:00', place: 'Vancouver',       team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'roundof16'},

        # ── Quarter-finals (match numbers 97-100) ────────────────────────────
        {start_at: '09.07.2026 22:00', place: 'Boston',          team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'quarterfinal'},
        {start_at: '10.07.2026 21:00', place: 'Los Angeles',     team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'quarterfinal'},
        {start_at: '11.07.2026 23:00', place: 'Miami',           team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'quarterfinal'},
        {start_at: '12.07.2026 03:00', place: 'Kansas City',     team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'quarterfinal'},
        ...
        {start_at: '15.07.2026 21:00', place: 'Atlanta',         team1_placeholder_name: '-', team2_placeholder_name: '-', group: nil, round: 'semifinal'},
